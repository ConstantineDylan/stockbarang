...
<html lang="en">
    <head>
        ...
        <title>Chatbot - Stock Barang</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Stocks Data</a>
            <!-- Sidebar Toggle-->
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $getdata = mysqli_query($conn,"SELECT * FROM stocks WHERE ownerid = '$ownerid'");
